  ...
  return (
    ...
    <a href="/login"><img src="/images/login.png" alt="login" width="50vw" height= "50vh"/></a>
      ...
      <section className='section1_home assessment'>
               <p className='main_text1'>The <span className='main_text_color1'>Smart<br/></span> Choice For <span className='main_text_color1'>Future</span></p>
      ...
      <section className='section3_home assessment_2'>
        ...
        <div className='section3_inside1'>
            ...
            <a href="/ai_or_manual"><div className='service1 new'><div className='image'><img src="/images/generate1.png" alt='ppt' width="200vw"/></div><p>Quizzes</p></div></a>
            <a href=""><div className='service1 new'><div className='image'><img src="/images/generate2.png" width="200vw"/></div><p>Tests</p></div></a>
            </div>
            <div className='services1'>
            <a href=""><div className='service1 new'><div className='image'><img src="/images/generate3.png" width="200vw"/></div><p>Assignments</p></div></a>
            <a href=""><div className='service1 new'><div className='image'><img src="/images/generate4.png" width="200vw"/></div><p>Case Study</p></div></a>
            </div>
        </div>
      </section>
      <section>
