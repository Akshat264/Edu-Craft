    ...
    return (
      ...
      <div className="buttons_section">
        <img src="/images/main_manual.png" width="50%"/>
            <div className="buttons_section1"><a href="/quizCreator" className="icon-link">
                <span className="icon_link"><img src='/images/manually.png' width="68vw"/></span>
                <span className="text_link">Manually</span>
              </a><a href="#" className="icon-link">
                <span className="icon_link"><img src='https://banner2.cleanpng.com/20191001/hpa/transparent-test-icon-educational-icons-icon-verified-text-pap-5d93b4186f5855.1024073315699609844561.jpg' width="64vw"/></span>
